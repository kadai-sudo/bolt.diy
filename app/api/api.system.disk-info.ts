...
try {
  ...
  // In Node.js environment, this will fail, which is expected
  console.log('Running in Node.js environment, child_process not available');
}
...
const getDiskInfo = (): DiskInfo[] => {
  // If we're in a node environment and not in development, return error
