            ...
            <body>
              <div class="device-container">
                ...
                <div class="device-frame">
                  <iframe src="${previewUrl}" sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin allow-downloads allow-top-navigation-by-user-activation" allow="clipboard-write clipboard-read fullscreen geolocation camera microphone display-capture accelerometer gyroscope magnetometer midi payment usb hid serial window-management storage-access cross-origin-isolated autoplay"></iframe>
                </div>
              </div>
            </body>
            </html>
                ...
                >
                  ...
                  >
                    ...
                    <iframe
                      ...
                      allow="cross-origin-isolated clipboard-write clipboard-read fullscreen geolocation camera microphone display-capture accelerometer gyroscope magnetometer midi payment usb hid serial window-management storage-access autoplay"
                    />
                  </div>
                </div>
              ) : (
